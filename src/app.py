...
activities.update({
    ...
    "Basketball Club": {
        "description": "Pickup games and skills development in basketball",
    ...
    "Music Ensemble": {
        "description": "Instrumental and vocal group rehearsals leading to performances",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions with hands-on projects and study",
